...
<table class="stripeMe">
    ...
    foreach($result AS $k=>$v){
        ...
        echo '<td>' . $v['nachname'] . '</td>' . PHP_EOL;
        echo '<td>' . $v['vorname'] . '</td>' . PHP_EOL;
        if ($v['bild'] == '') {
            echo  '<td><a href="' . base_url() . 'media/redaktion/images/autor/thumbs/thumb_unbekannt_autor.png  "class="preview">' . $v['vorname'] . ' ' . $v['nachname']. '</a></td>' . PHP_EOL;
        }else  {
            echo '<td><a href="' . base_url() . 'media/redaktion/images/autor/thumbs/thumb_' . $v['bild'] . '"class="preview">' . $v['vorname'] . ' ' . $v['nachname']. '</a></td>' . PHP_EOL;
        }
