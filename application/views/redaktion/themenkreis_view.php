...
echo form_error('themenkreis') ? '<div ' . $fehler . '>' . PHP_EOL : '<div>' . PHP_EOL;
echo form_label('Themenkreis*:', 'themenkreis') . PHP_EOL;
echo form_input('themenkreis', set_value('themenkreis', $themenkreis)) . PHP_EOL;
echo '</div>' . PHP_EOL;
