...
class GenreUebersicht extends Adminpage_controller {

    protected $sControllerName  = '';
    protected $sTable           = 'genre';
    protected $sUriEdit         = 'genre';
...
/* End of file genreuebersicht.php */
/* Location: ./buchverwaltung/application/controllers/redaktion/genreuebersicht.php */