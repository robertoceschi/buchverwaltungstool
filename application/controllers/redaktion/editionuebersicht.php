...
class EditionUebersicht extends Adminpage_controller {

    protected $sControllerName  = '';
    protected $sTable           = 'edition';
    protected $sUriEdit         = 'edition';
...
/* End of file editionsuebersicht.php */
/* Location: ./buchverwaltung/application/controllers/redaktion/editionsuebersicht.php */