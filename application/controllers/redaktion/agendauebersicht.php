...
class AgendaUebersicht extends Adminpage_controller {

    protected $sControllerName  = '';
    protected $sTable           = 'agenda';
    protected $sUriEdit         = 'agenda';
    ...
    public function index($iCurrentPage = 0) {
        ...
        $aData['tablehead'] = array('Datum', 'Zeit', 'Titel', 'Ort', 'Bild');
        ...
        $aData['result'] = $this->Model->getAll($sTable = $this->sTable,
                                                $sSpecialSql   = '',
                                                $sFields       = 'agenda_id, datum, zeit, titel, ' .
                                                                 'ort, bild, status',
                                                $aJoinLeft     = '',
                                                $aWhere        = $wherearr,
                                                $sGroupBy      = '',
...
/* End of file agendauebersicht.php */
/* Location: ./buchverwaltung/application/controllers/redaktion/agendauebersicht.php */