...
class MedienUebersicht extends Adminpage_controller {

    protected $sControllerName  = '';
    protected $sTable           = 'medium';
    protected $sUriEdit         = 'medium';
...
/* End of file medienuebersicht.php */
/* Location: ./buchverwaltung/application/controllers/redaktion/medienuebersicht.php */