...
class NutzerUebersicht extends Adminpage_controller {

    protected $sControllerName  = '';
    protected $sTable           = 'nutzer';
    protected $sUriEdit         = 'nutzer';
    ...
    public function index($iCurrentPage = 0) {
        ...
        $aData['tablehead'] = array('Nachname', 'Vorname', 'Benutzername', 'Emailadresse');
        ...
        $aData['result'] = $this->Model->getAll($sTable = $this->sTable,
                                                $sSpecialSql   = '',
                                                $sFields       = 'nutzer_id, nachname, vorname, ' .
                                                                 'benutzername, emailadresse, status',
                                                $aJoinLeft     = '',
                                                $aWhere        = $wherearr,
                                                $sGroupBy      = '',
                                                $sOrder        = $order,
...
/* End of file nutzeruebersicht.php */
/* Location: ./buchverwaltung/application/controllers/redaktion/nutzeruebersicht.php */