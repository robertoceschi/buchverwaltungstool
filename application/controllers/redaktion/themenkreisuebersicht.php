...
class ThemenkreisUebersicht extends Adminpage_controller {

    protected $sControllerName  = '';
    protected $sTable           = 'themenkreis';
    protected $sUriEdit         = 'themenkreis';
    ...
    public function index($iCurrentPage = 0) {
        ...
        // Suchformular
        //--------------------------------------//
        $searchfields = array('themenkreis');
        ...
        $aData['tablehead'] = array('Themenkreis');
        ...
        //--------------------------------------//
            ...
            $sSpecialSql   = '',
            $sFields       = 'themenkreis_id, themenkreis',
            $aJoinLeft     = '',
            $aWhere        = $wherearr,
            $sGroupBy      = '',
            $sOrder        = $order,
...
/* End of file themenkreisuebersicht.php */
/* Location: ./buchverwaltung/application/controllers/redaktion/themenkreisuebersicht.php */